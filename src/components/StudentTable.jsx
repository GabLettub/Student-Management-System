      ...
      <Table.TBody>
        {filteredStudents.length > 0 ? (
          filteredStudents.map((student, index) => (
            <Table.Row key={index}>
              <Table.Column className="text-black">{student.lastName}</Table.Column>
              <Table.Column className="text-black">{student.firstName}</Table.Column>
              <Table.Column className="text-black">{student.course}</Table.Column>
              <Table.Column className="text-black">{student.birthdate}</Table.Column>
              <Table.Column className="text-black">{calculateAge(student.birthdate)}</Table.Column>
            </Table.Row>
          ))
        ) : (
          <Table.Row>
